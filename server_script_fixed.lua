			...
			if waypointIndex <= #pathWaypoints and gameActive and fatherMoving then
				...
				connection = fatherHumanoid.MoveToFinished:Connect(function(reached)
					...
					if waypointIndex <= #pathWaypoints and gameActive and fatherMoving then
						...
						print("All waypoints reached or movement stopped")
						fatherMoving = false
				...
				print("Cannot continue waypoint movement - waypointIndex:", waypointIndex, "total:", #pathWaypoints, "gameActive:", gameActive, "fatherMoving:", fatherMoving)
				fatherMoving = false
				scheduleNextMovement()
			end
		end
...
print("Horror game initialized with enhanced debugging!")